...
# 838 "..\\system_stm32f4xx.c"
  ...
  ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->PLLCFGR = 16 | (400 << 6) | (((4 >> 1) -1) << 16) | (7 << 24); 

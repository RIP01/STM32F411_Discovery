...
int main(void)
{
  ...
  while (1)
  {
    ...
    {
      GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0400)) ,((uint16_t)0x0001) | ((uint16_t)0x0002) );
    }
    else
    {
      GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0400)) ,((uint16_t)0x0001) | ((uint16_t)0x0002) );
    }
  }
}
...
void GPIO_Configuration(void)
{
  RCC_AHB1PeriphClockCmd(((uint32_t)0x00000002) | ((uint32_t)0x00000001), ENABLE);
